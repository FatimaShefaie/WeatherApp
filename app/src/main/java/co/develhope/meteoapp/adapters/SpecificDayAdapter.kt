...
import co.develhope.meteoapp.data.dataModel.DailyScreenItems.CardForecast
...
class SpecificDayAdapter(private val newList: List<DailyScreenItems>) :
    ...
    class SpecificDayTitleViewHolder(private val specificDayTitle: SpecificDayTitleBinding) :
        ...
        fun bind(title: DailyScreenItems.Title) {
           ...
           // specificDayTitle.situationTxt.text=itemView.context.getString(R.string.specificDay_situation,title.situation)
        }
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder) {
            ...
            is SpecificDayCardViewHolder -> holder.bind(newList[position] as CardForecast)
